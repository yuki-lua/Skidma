...
local ScreenGuitwo = game.Players.LocalPlayer.PlayerGui.RektskyNotificationGui
...
local sprintthingy = KnitClient.Controllers.SprintController
...
Tabs["Player"]:CreateToggle({
	...
	["Callback"] = function(v)
		if v then
			local antivoidpart = Instance.new("Part", game.Workspace)
